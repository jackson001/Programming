...
public class DeleteClass extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         ...
         try {
            ...
            String sql = "delete from teaches where Lecturerid = ? and subjectid = ?";
            pst = (PreparedStatement) conn.prepareStatement(sql);
            pst.setString(1, jTextField1.getText());
            pst.setString(2, jComboBox1.getSelectedItem().toString());
            pst.executeUpdate();
            int op = JOptionPane.showConfirmDialog(null,"Class deleted. More classes to delete?","Saved",0);
            if(op==0){
                dispose();
            }
            else if(op==1){
    ...
    void setit(String text1) {
        try {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendant", "root", "");
            String sql1 = "select * from teaches where Lecturerid=?";
            pst = (PreparedStatement) conn.prepareStatement(sql1);
            pst.setString(1, id);
            rs = (ResultSet) pst.executeQuery();
            while(rs.next()) {
                String sname1 = rs.getString("subjectid");
