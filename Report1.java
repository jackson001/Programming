...
public class Report1 extends javax.swing.JFrame {
    ...
    pst  = (PreparedStatement) conn.prepareStatement(sql);
    pst.setString(1, jLabel1.getText());
                rs1 = (ResultSet) pst.executeQuery();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
           final JComboBox area;
           final JComboBox area1;
           final JComboBox area2;
           String name1;
           String name2;
           area = new  JComboBox();
           area1 = new  JComboBox();
        ...
        try {
            ...
            pst1 = (PreparedStatement) conn.prepareStatement(sql2);
           ...
           String namee;
            try{
                Class.forName("com.mysql.jdbc.Driver");
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendant", "root", "");
            String sql3 = "select distinct(Lecturerid) from lecturer where Department=?";
            pst = (PreparedStatement) conn.prepareStatement(sql3);
            pst.setString(1, area.getSelectedItem().toString());
            ResultSet rs4 = (ResultSet) pst.executeQuery();

            while (rs4.next()) {
                namee = rs4.getString("Lecturerid");
                area2.addItem(namee);
            }
            ...
            Class.forName("com.mysql.jdbc.Driver");
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendant", "root", "");
            String sql4 = "select * from teaches where Lecturerid=?";
            pst = (PreparedStatement) conn.prepareStatement(sql4);
            pst.setString(1, area2.getSelectedItem().toString());
            ResultSet rs5 = (ResultSet) pst.executeQuery();

            while (rs5.next()) {
            Class.forName("com.mysql.jdbc.Driver");
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendant", "root", "");
            String sql = "select distinct(subjectid) from attendence where subjectid=?";
            pst = (PreparedStatement) conn.prepareStatement(sql);
            pst.setString(1, rs5.getString("subjectid"));
            ResultSet rs6 = (ResultSet) pst.executeQuery();

            while (rs6.next()) {
                String name = rs6.getString("subjectid");
                area1.addItem(name);
            }
            }
        }catch (ClassNotFoundException | SQLException e) {
        ...
        JLabel l3 = new JLabel("Lecturer");
        area.setFont(new Font("Arial", Font.BOLD, 18));
        area1.setFont(new Font("Arial", Font.BOLD, 18));
        area2.setFont(new Font("Arial", Font.BOLD, 18));
        label2.add(l);
        label2.add(area);
        label2.add(l3);
        label2.add(area2);
        ...
        int reply = JOptionPane.showConfirmDialog(this, label, "Choose The Department And The Course", JOptionPane.YES_NO_OPTION, HEIGHT, Image);
    ...
    {
        setit(area1.getSelectedItem().toString());
    try {
        String sql3 = "select * from teaches where subjectid=?";
            PreparedStatement pst2 = (PreparedStatement) conn.prepareStatement(sql3);
            pst2.setString(1, area1.getSelectedItem().toString());
            ResultSet rs2 = (ResultSet) pst2.executeQuery();
            if (rs2.next()) {
                 name2 = rs2.getString("Lecturerid");
                 setit2(name2);
    ...
    public Print()
    {
        ...
        Class.forName("com.mysql.jdbc.Driver");
            ...
            JOptionPane.showMessageDialog(null, e);
                ...
                fac1=new JTextField();
                fac1.setFont(new Font("Arial",Font.BOLD,11));
                ...
                dep1=new JTextField();
                dep1.setFont(new Font("Arial",Font.BOLD,11));
                ...
                cod1=new JTextField();
                cod1.setFont(new Font("Arial",Font.BOLD,11));
                ...
                dat1=new JTextField();
                dat1.setFont(new Font("Arial",Font.BOLD,11));
                ...
                tit1=new JTextField();
                tit1.setFont(new Font("Arial",Font.BOLD,11));
                ...
                cf1=new JTextField();
                cf1.setFont(new Font("Arial",Font.BOLD,11));
                ...
                jp.add(jsp);*/
                jTable2.setBounds(20,250,screenSize.width - 40,screenSize.height - 350);
                JScrollPane scr=new JScrollPane(jTable2);
    ...
    void setit(String text) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(null, "No attendance added!");
