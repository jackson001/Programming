...
public class PassChange extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("New password does not match.");

        jLabel9.setForeground(new java.awt.Color(255, 51, 51));
        jLabel9.setText("Wrong old password.");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jPasswordField3, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/password_logo.jpg"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String newp=new String(jPasswordField2.getPassword());
        String rnewp=new String(jPasswordField3.getPassword());
        
        try
        {
        Class.forName("com.mysql.jdbc.Driver");
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/attendant","root","");
        PreparedStatement ps=con.prepareStatement("select password from studentlogin where RegNo=?");
        ps.setString(1,jLabel10.getText());
        ...
        else
        {
            ...
            {
                PreparedStatement ps2=con.prepareStatement("update studentlogin set password=? where RegNo=?");
                ps2.setString(1,newp);
                ps2.setString(2,jLabel10.getText());
                ps2.executeUpdate();
