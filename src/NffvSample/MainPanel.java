...
public class MainPanel extends JPanel implements ActionListener, ListSelectionListener{
	...
	public MainPanel(ScannerModule[] scanners, String database, String password){
		...
		users.setBorder(new TitledBorder("Students"));
		...
		clearusers = new JButton("Clear Students");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource() == enroll){
			...
			String name = JOptionPane.showInputDialog(this,new JLabel("Please enter student's name"),"Enter");
			if(name == null) return;
		...
		if(arg0.getSource() == verify){
			...
			if(selection == null){
				JOptionPane.showMessageDialog(this,"Please select a student to verify with","Error",JOptionPane.ERROR_MESSAGE);
				return;
			}
