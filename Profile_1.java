...
import java.sql.*;
class Profile_1 extends JFrame implements ActionListener
{
	...
	public static void main(String ar[])
	{
        ...
        try {
            ...
            iddd = rs.getString("Lecturerid");
            String sql1 = "select * from profile where Lecturerid=?";
            pst1 = (PreparedStatement) conn.prepareStatement(sql1);
            pst1.setString(1, iddd);
            rs1 = (ResultSet) pst1.executeQuery();
            
            if (rs1.next()) {
                String id = rs1.getString("Nationalid");
                String dob = rs1.getString("DOB");
                String gender = rs1.getString("gender");
                String status = rs1.getString("status");
                String a = rs1.getString("address");
                String c = rs1.getString("city");
                String p = rs1.getString("phone");
                String e = rs1.getString("email");
                String d = rs1.getString("dept");
             
                t2.setText(id);
                t5.setText(dob);
                cmb.setSelectedItem(gender);
                t10.setSelectedItem(status);
                t8.setText(a);
                t9.setText(c);
                t13.setText(p);
                t14.setText(e);
                ...
                JOptionPane.showMessageDialog(null, "Please add your profile " + t3.getText()+"!");
            }
        } catch (Exception e) {
